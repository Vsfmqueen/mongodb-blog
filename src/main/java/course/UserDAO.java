...
public class UserDAO {
    ...
    public DBObject validateLogin(String username, String password) {
        QueryBuilder builder = QueryBuilder.start("_id");
        builder.is(username);

        DBObject user = usersCollection.findOne(builder.get());
        System.out.print(user.get("_id"));
        System.out.print(user.get("password"));
